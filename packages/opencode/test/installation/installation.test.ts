...
describe("installation", () => {
  describe("latest", () => {
    ...
    test("reads npm versions via npm view", async () => {
      ...
      expect(calls).toContainEqual(["npm", "view", `@leohenon/ocv@${InstallationChannel}`, "version", "--json"])
    })
    ...
    test("reads npm versions via bun pm view", async () => {
      ...
      expect(calls).toContainEqual(["bun", "pm", "view", `@leohenon/ocv@${InstallationChannel}`, "version", "--json"])
    })
    ...
    test("reads npm versions via pnpm view", async () => {
      ...
      expect(calls).toContainEqual(["pnpm", "view", `@leohenon/ocv@${InstallationChannel}`, "version", "--json"])
    })
