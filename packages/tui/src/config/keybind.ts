...
export const Definitions = {
  ...
  sidebar_line_up: keybind("none", "Scroll sidebar up by one line"),
  sidebar_line_down: keybind("none", "Scroll sidebar down by one line"),
  sidebar_page_up: keybind("none", "Scroll sidebar up by half a page"),
  sidebar_page_down: keybind("none", "Scroll sidebar down by half a page"),
...
export const CommandMap = {
  ...
  sidebar_line_up: "session.sidebar.line.up",
  sidebar_line_down: "session.sidebar.line.down",
  sidebar_page_up: "session.sidebar.page.up",
  sidebar_page_down: "session.sidebar.page.down",
